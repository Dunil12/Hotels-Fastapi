...
#                               price=100,
#                               date_from=date(year=2025, month=8, day=2),
#                               date_to=date(year=2025, month=8, day=15),
#                               room_id=room_id)
...
#     assert new_booking.date_from == date(year=2025, month=8, day=2)
#     assert new_booking.date_to == date(year=2025, month=8, day=15)
#
#
#     # update
#     new_booking_data = BookingPatch(date_from=date(year=2025, month=8, day=1),
#                                     date_to=date(year=2025, month=8, day=16),
#                                     price=50)
#     new_booking = await db.bookings.change(new_booking_data, user_id=user_id, room_id=room_id)
#
#     assert new_booking.price == 50
#     assert new_booking.date_from == date(year=2025, month=8, day=1)
#     assert new_booking.date_to == date(year=2025, month=8, day=16)
#
#
#     # удалим
